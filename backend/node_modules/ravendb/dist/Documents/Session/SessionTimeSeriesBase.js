...
class SessionTimeSeriesBase {
    ...
    async getTimeSeriesAndIncludes(from, to, includes, start, pageSize) {
        ...
        if (document) {
            ...
            if (metadataTimeSeries && TypeUtil_1.TypeUtil.isArray(metadataTimeSeries)) {
                if (!metadataTimeSeries.some(x => StringUtil_1.StringUtil.equalsIgnoreCase(x, this.name))) {
                    return [];
                }
            }
        }
    ...
    _notInCache(from, to) {
        ...
        return ranges.length === 0
            ...
            || DatesComparator_1.DatesComparator.compare((0, DatesComparator_1.rightDate)(ranges.at(-1).to), (0, DatesComparator_1.leftDate)(from)) < 0;
    }
}
