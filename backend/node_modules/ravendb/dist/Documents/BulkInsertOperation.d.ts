...
export declare class BulkInsertOperation {
    ...
    private _bulkInsertExecuteTaskErrored;
    private _stream;
    private _first;
    ...
    private _compressedStream;
    private _requestBodyStream;
    private _requestBodyStreamFinished;
    private _currentWriter;
    private _backgroundWriter;
    private _asyncWrite;
    private _asyncWriteDone;
    private static readonly _maxSizeInBuffer;
    ...
    private writeToRequestBodyStream;
